...
class PipelineConfig:
    ...
    def __init__(self, name, notebooks, configuration, storage, target, policy=None):
        """
...
def configure_pipeline(self, notebooks, name=None, source=None, configuration=None):
    """
...
@DBAcademyHelper.monkey_patch
def start_pipeline(self, pipeline_id=None):
    """
