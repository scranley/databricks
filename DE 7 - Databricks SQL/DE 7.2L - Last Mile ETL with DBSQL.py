...
# MAGIC
# MAGIC Steps:
# MAGIC 1. Locate the **Schedule** button on the top right of the SQL query editor box
# MAGIC 1. Use the drop down to select to refresh every **1 week**, and set the time to **12:00**
# MAGIC 1. For day of week, select **Sunday**.
# MAGIC 1. Click **OK**
# MAGIC
...
# MAGIC
# MAGIC Steps:
# MAGIC 1. Click the **Share** button
